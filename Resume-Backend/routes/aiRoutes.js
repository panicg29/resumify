...
router.post('/process-pdf-complete', upload.single('pdf'), async (req, res) => {
  ...
  try {
    ...
    const resumeData = {
      ...
      professionalMemberships: parsedData.professionalMemberships || [],
      conferences: parsedData.conferences || [],
      speakingEngagements: parsedData.speakingEngagements || [],
      teachingExperience: parsedData.teachingExperience || [],
      mentoring: parsedData.mentoring || [],
      leadershipRoles: parsedData.leadershipRoles || [],
      internships: parsedData.internships || [],
      licenses: parsedData.licenses || [],
      references: parsedData.references || [],
      socialMedia: parsedData.socialMedia || {},
      hobbies: parsedData.hobbies || [],
      interests: parsedData.interests || [],
      openSourceContributions: parsedData.openSourceContributions || [],
