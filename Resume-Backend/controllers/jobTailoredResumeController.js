...
const generateJobAlignedResume = async (req, res) => {
  try {
    ...
    const resumePayload = {
      ...
      certifications: aiResume.certifications || baseResume.certifications || [],
      trainings: aiResume.trainings || baseResume.trainings || [],
      awards: aiResume.awards || baseResume.awards || [],
      languages: aiResume.languages || baseResume.languages || [],
      publications: aiResume.publications || baseResume.publications || [],
      patents: aiResume.patents || baseResume.patents || [],
      volunteerWork: aiResume.volunteerWork || baseResume.volunteerWork || [],
      professionalMemberships: aiResume.professionalMemberships || baseResume.professionalMemberships || [],
      conferences: aiResume.conferences || baseResume.conferences || [],
      speakingEngagements: aiResume.speakingEngagements || baseResume.speakingEngagements || [],
      teachingExperience: aiResume.teachingExperience || baseResume.teachingExperience || [],
      mentoring: aiResume.mentoring || baseResume.mentoring || [],
      leadershipRoles: aiResume.leadershipRoles || baseResume.leadershipRoles || [],
      internships: aiResume.internships || baseResume.internships || [],
      licenses: aiResume.licenses || baseResume.licenses || [],
      references: aiResume.references || baseResume.references || [],
      socialMedia: aiResume.socialMedia || baseResume.socialMedia || {},
      hobbies: aiResume.hobbies || baseResume.hobbies || [],
      interests: aiResume.interests || baseResume.interests || [],
      openSourceContributions: aiResume.openSourceContributions || baseResume.openSourceContributions || [],
      additionalInfo: aiResume.additionalInfo || baseResume.additionalInfo || '',
      location: aiResume.location || baseResume.location || '',
      role: aiResume.role || baseResume.role || '',
