                ...
                <a
                  onClick={e => {
                    ...
                    if (item.onClick) {
                      ...
                      // Default navigation behavior if no onClick handler
