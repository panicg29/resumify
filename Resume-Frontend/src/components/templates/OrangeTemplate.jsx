    ...
    <div className="min-h-screen bg-white text-gray-900 font-sans">
      ...
      <div className="bg-gradient-to-r from-orange-500 to-red-500 text-white p-8">
        <div className="max-w-4xl mx-auto">
          ...
          {formData.personalInfo?.title && (
            <p className="text-xl text-orange-100 mb-6">{formData.personalInfo.title}</p>
          )}
      ...
      <div className="max-w-4xl mx-auto p-8">
        ...
        {formData.personalInfo?.summary && (
          <div className="mb-8">
            <h2 className="text-2xl font-bold text-orange-600 mb-4 border-b-2 border-orange-500 pb-2">Professional Summary</h2>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
          ...
          <div className="lg:col-span-1">
            ...
            {formData.education?.school && (
              <div className="mb-8">
                <h3 className="text-xl font-bold text-orange-600 mb-4">Education</h3>
                <div className="bg-orange-50 p-4 rounded-lg border border-orange-200">
                  <h4 className="font-semibold text-gray-800">{formData.education.degree}</h4>
                  <p className="text-orange-700">{formData.education.school}</p>
          ...
          <div className="lg:col-span-2">
            ...
            {formData.experience && formData.experience.length > 0 && formData.experience[0].company && (
              <div className="mb-8">
                <h3 className="text-xl font-bold text-orange-600 mb-4">Experience</h3>
            ...
            {formData.projects && formData.projects.length > 0 && formData.projects[0].name && (
              <div className="mb-8">
                <h3 className="text-xl font-bold text-orange-600 mb-4">Projects</h3>
                  ...
                  {formData.projects.map((project, index) => (
                    <div key={index} className="bg-orange-50 p-4 rounded-lg border border-orange-200">
                      ...
                      {project.technologies && (
                        <p className="text-orange-600 text-sm mt-2 font-medium">{project.technologies}</p>
                      )}
                    </div>
                  ))}
                </div>
