    ...
    <div className="min-h-screen bg-gray-100 text-gray-900 font-sans">
      ...
      <div className="bg-gradient-to-r from-gray-600 to-gray-800 text-white p-8">
        <div className="max-w-4xl mx-auto">
          ...
          {formData.personalInfo?.title && (
            <p className="text-xl text-gray-300 mb-6">{formData.personalInfo.title}</p>
          )}
      ...
      <div className="max-w-4xl mx-auto p-8">
        ...
        {formData.personalInfo?.summary && (
          <div className="mb-8">
            <h2 className="text-2xl font-bold text-gray-700 mb-4 border-b-2 border-gray-500 pb-2">Professional Summary</h2>
              ...
              <div className="mb-8">
                ...
                <div className="space-y-4">
                  {formData.projects.map((project, index) => (
                    <div key={index} className="bg-gray-200 p-4 rounded-lg border border-gray-300">
                      <h4 className="font-bold text-gray-800">{project.name}</h4>
                      {project.description && (
                        <p className="text-gray-700 text-sm mt-1">{project.description}</p>
                      )}
                      {project.technologies && (
                        <p className="text-gray-600 text-sm mt-2 font-medium">{project.technologies}</p>
                      )}
                    </div>
                  ))}
                </div>
