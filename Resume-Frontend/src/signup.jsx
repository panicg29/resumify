              ...
              <FormField>
                <div className="flex items-start space-x-3">
                  <Checkbox
                    ...
                    className="mt-1 border-gray-600 bg-gray-800 text-white"
                  />
                  <FormLabel htmlFor="terms" className="text-sm text-gray-300 leading-relaxed cursor-pointer">
                    I agree to the{' '}
                    <a href="#" className="text-white hover:text-gray-300 font-medium underline">Terms of Service</a>
                    {' '}and{' '}
                    <a href="#" className="text-white hover:text-gray-300 font-medium underline">Privacy Policy</a>
                  </FormLabel>
                </div>
              </FormField>
